...
namespace System.Web.Mvc
{
    public class DefaultControllerFactory : IControllerFactory
    {
        ...
        protected internal virtual IController GetControllerInstance(RequestContext requestContext, Type controllerType)
        {
            ...
            //以前在2.0中是直接  return (IController)Activator.CreateInstance(controllerType);
            //现在是将权限交给了 创建的ControllerActivator来实现
        ...
        {
            //卧槽 跳到我们需要的IDependencyResolver了
            ...
            public IController Create(RequestContext requestContext, Type controllerType)
            {
                try
                {
                    //以前是通过无参数的构造函数，利用activator.createInstance来创建，现在 是优先由 IDependencyResolver.GetService来创建实例
